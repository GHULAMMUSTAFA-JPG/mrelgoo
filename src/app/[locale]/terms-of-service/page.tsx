            ...
            <Box mt={{ base: '20px', md: '24px' }} maxW='848px'>
              ...
              <VStack gap='12px'>
                ...
                <Text
                  ...
                  textColor={colors.black}
                >
                  We are AI THINGS LLC ("<b>Company</b>," "<b>we</b>," "
                  <b>us</b>," "<b>our</b>"), a company registered in Wyoming,
                  United States. We operate the website{' '}
                  <a
                    href='http://www.baby.zone'
                    target='_blank'
                    rel='noreferrer'
                    style={{ color: '#3030F1 ' }}
                  >
                  ...
                  <b>Legal Terms</b>") (collectively, the "<b>Services</b>"). We
                  provide AI future baby generated photos using our trusted
                  third party partner (in the US) that we have a secure &
                  private access with. Along with a well designed story (free
                  gift) for our users to use on their social media if they want.
                  You can contact us by email at contact@baby.zone. These Legal
                  Terms constitute a legally binding agreement made between you,
                  whether personally or on behalf of an entity ("<b>you</b>"),
                  and AI THINGS LLC, concerning your access to and use of the
                  ...
                  conditions or documents that may be posted on the Services
                  from time to time are hereby expressly incorporated herein by
                  reference. We reserve the right, in our sole discretion, to
                  make changes or modifications to these Legal Terms from time
                  ...
                  changes in any revised Legal Terms by your continued use of
                  the Services after the date such revised Legal Terms are
                  posted. The Services are intended for users who are at least
                  18 years old. Persons under the age of 18 are not permitted to
                  use or register for the Services. We recommend that you print
                  ...
                  <br />
                  <a href='#services' style={{ color: 'blue' }}>
                    {' '}
                    1. OUR SERVICES
                    <br />
                  </a>
                  <a href='#ip' style={{ color: 'blue' }}>
                    {' '}
                    2. INTELLECTUAL PROPERTY RIGHTS
                    <br />
                  </a>
                  <a href='#userreps' style={{ color: 'blue' }}>
                  ...
                  <a href='#purchases' style={{ color: 'blue' }}>
                    5. PURCHASES AND PAYMENT
                    <br />
                  </a>
                  <a href='#REFUNDSPOLICY' style={{ color: 'blue' }}>
                    6. REFUNDS POLICY
                    <br />
                  </a>
                  <a href='#PROHIBITEDACTIVITIES' style={{ color: 'blue' }}>
                    7. PROHIBITED ACTIVITIES
                    <br />
                  </a>
                  <a
                    href='#USERGENERATEDCONTRIBUTIONS'
                    style={{ color: 'blue' }}
                  >
                    8. USER GENERATED CONTRIBUTIONS
                    <br />
                  </a>
                  <a href='#CONTRIBUTIONLICENSE' style={{ color: 'blue' }}>
                    9. CONTRIBUTION LICENSE
                    <br />
                  </a>
                  <a href='#GUIDELINESFORREVIEWS' style={{ color: 'blue' }}>
                    10. GUIDELINES FOR REVIEWS
                    <br />
                  </a>
                  <a
                    href='#THIRDPARTYWEBSITESANDCONTENT'
                    style={{ color: 'blue' }}
                  >
                    11. THIRD-PARTY WEBSITES AND CONTENT
                    <br />
                  </a>
                  <a href='#SERVICESMANAGEMENT' style={{ color: 'blue' }}>
                  ...
                  <a href='#COPYRIGHTINFRINGEMENTS' style={{ color: 'blue' }}>
                    14. COPYRIGHT INFRINGEMENTS
                    <br />
                  </a>
                  <a href='#TERMANDTERMINATION' style={{ color: 'blue' }}>
                    15. TERM AND TERMINATION
                    <br />
                  </a>
                  <a
                    href='#MODIFICATIONSANDINTERRUPTION'
                    style={{ color: 'blue' }}
                  >
                    16. MODIFICATIONS AND INTERRUPTIONS
                    <br />
                  </a>
                  <a href='#GOVERNINGLAW' style={{ color: 'blue' }}>
                    17. GOVERNING LAW
                    <br />
                  </a>
                  <a href='#DISPUTERESOLUTION' style={{ color: 'blue' }}>
                    18. DISPUTE RESOLUTION
                    <br />
                  </a>
                  <a href='#CORRECTIONS' style={{ color: 'blue' }}>
                    19. CORRECTIONS
                    <br />
                  </a>
                  <a href='#DISCLAIMER' style={{ color: 'blue' }}>
                    20. DISCLAIMER
                    <br />
                  </a>
                  <a href='#LIMITATIONSOFLIABILITY' style={{ color: 'blue' }}>
                    21. LIMITATIONS OF LIABILITY
                    <br />
                  </a>
                  <a href='#INDEMNIFICATION' style={{ color: 'blue' }}>
                    22. INDEMNIFICATION
                    <br />
                  </a>
                  <a href='#USERDATA' style={{ color: 'blue' }}>
                    23. USER DATA
                    <br />
                  </a>
                  <a
                    href='#ELECTRONICCOMMUNICATIONSTRANSACTIONSANDSIGNATURES'
                    style={{ color: 'blue' }}
                  >
                  ...
                  <a
                    href='#CALIFORNIAUSERSANDRESIDENTS'
                    style={{ color: 'blue' }}
                  >
                    25. CALIFORNIA USERS AND RESIDENTS
                    <br />
                  </a>
                  <a href='#MISCELLANEOUS' style={{ color: 'blue' }}>
                    26. MISCELLANEOUS
                    <br />
                  </a>
                  <a href='#FDPOLICY' style={{ color: 'blue' }}>
                    27. REFUND POLICY
                    <br />
                  </a>
                  <a href='#CONTACTUS' style={{ color: 'blue' }}>
                    28. CONTACT US
                  </a>
                  <br />
                  <div id='services'>
                  ...
                  "AS IS" for your personal, non-commercial use only. <br />{' '}
                  <br />
                  <h4
                    style={{
                      marginBottom: '12px',
                  ...
                  the{' '}
                  <a href='#PROHIBITEDACTIVITIES' style={{ color: '#3030F1 ' }}>
                  ...
                  contact@baby.zone. If we ever grant you the permission to
                  ...
                  the Services, Content, and Marks. <br /> <br />
                  Any breach of these Intellectual Property Rights will
                  constitute a material breach of our Legal Terms and your right
                  to use our Services will terminate immediately. <br /> <br />
                  <h4
                    style={{
                      marginBottom: '12px',
                      fontSize: '17px',
                  ...
                  you post or upload any content through the Services. <br />{' '}
                  <br />
                  ...
                  forums, and other functionality during which you may create,
                  ...
                  images you provide. <br /> <br />
                  <b>You are responsible for what you post or upload:</b> By
                  sending us Submissions and/or posting Contributions through
                  ...
                  <ul style={{ marginLeft: '20px', marginBottom: '10px' }}>
                    ...
                    <li>
                      ...
                      licenses to submit such Submissions and/or Contributions
                  ...
                  disable your account and report you to the authorities. <br />{' '}
                  <br />
                  <h4
                    style={{
                      marginBottom: '12px',
                  ...
                  <a href='#copyrightyes' style={{ color: '#3030F1 ' }}>
                  ...
                  not violate any applicable law or regulation. <br /> <br />
                  If you provide any information that is untrue, inaccurate, not
                  current, or incomplete, we have the right to suspend or
                  terminate your account and refuse any and all current or
                  future use of the Services (or any portion thereof). <br />
                  <br />
                  <div id='products'>
                    <h2
                      style={{
                  ...
                  <br />
                  <div id='USERGENERATEDCONTRIBUTIONS'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                  ...
                  <ul style={{ marginLeft: '20px' }}>
                    ...
                    <li>
                      our Contributions do not violate any applicable law
                  ...
                  <br />
                  <br />
                  <div id='THIRDPARTYWEBSITESANDCONTENT'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                  ...
                  content that are excessive in size or are in any way . By
                  using the Services, you agree to be bound by our Privacy
                  ...
                  Privacy Policy:{' '}
                  <a
                    href='https://baby.zone/privacy-policy'
                    style={{ color: 'blue' }}
                  >
                    {' '}
                    https://baby.zone/privacy-policy
                  </a>
                  ...
                  are not sure that material located on or linked to by the
                  Services infringes your copyright, you should consider first
                  contacting an attorney.
                  <br />
                  <br />
                  <div id='TERMANDTERMINATION'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                  ...
                  <br />
                  <br />
                  <div id='MODIFICATIONSANDINTERRUPTION'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                    ...
                    >
                      16. MODIFICATIONS AND INTERRUPTION
                    </h2>
                    <br />
                  </div>
                  ...
                  will take place in Wyoming. Except as otherwise provided
                  ...
                  the state and federal courts located in United States,
                  ...
                  <br />
                  <br />
                  <div id='ELECTRONICCOMMUNICATIONSTRANSACTIONSANDSIGNATURES'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                  ...
                  <br />
                  <br />
                  <div id='CALIFORNIAUSERSANDRESIDENTS'>
                    <h2
                      style={{
                        marginBottom: '5px',
                        fontSize: '19px',
                  ...
                  We don't offer refunds once the delivery has been sent through
                  email. Instead, we may offer up to 2 free revisions.
                  <br />
                  <br />
                  <div id='CONTACTUS'>
                    <h2
                  ...
                  <br />
                  <br />
                  <strong>contact@baby.zone</strong>
                  <br />
                </Text>
              </VStack>
            </Box>
